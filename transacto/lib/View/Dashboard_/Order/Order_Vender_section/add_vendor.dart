...
class AddVendorPage extends StatefulWidget {
  final Function(Map<String, dynamic>) onAddVendor;
  final Map<String, String> existingVendor;

  AddVendorPage({required this.onAddVendor, required this.existingVendor});
...
class _AddVendorPageState extends State<AddVendorPage> {
  ...
  void initState() {
    ...
    fetchCustomers();
    fetchProducts();
    selectedCustomer = widget.existingVendor['name'];
    phoneController.text = widget.existingVendor['phone'] ?? '';
    addressController.text = widget.existingVendor['address'] ?? '';
  }
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                _buildInfoRow('Name:', VendorData['name']),
                SizedBox(height: 5),
                _buildInfoRow('Phone:', VendorData['phone']),
                SizedBox(height: 5),
                _buildInfoRow('Address:', VendorData['address']),
                SizedBox(height: 20),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      'Rs ${VendorData['totalAmount'].toStringAsFixed(2)}', // Use Rs instead of $
                      style: TextStyle(
                        fontSize: MediaQuery.of(context).size.width < 600 ? 13 : 20, // Adjust font size for mobile
                        fontWeight: FontWeight.bold,
                        color: Colors.green,
                ...
                // Date
                _buildInfoRow('Date:', VendorData['date']),
              ],
            ),
          ),
        ),
