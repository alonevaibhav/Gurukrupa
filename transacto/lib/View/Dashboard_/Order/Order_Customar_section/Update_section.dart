...
class UpdateOrderCustomerPage extends StatefulWidget {
  final Function(Map<String, dynamic>) onAddCustomer;
  final Map<String, String> existingCustomer;

  UpdateOrderCustomerPage({
    required this.onAddCustomer,
    required this.existingCustomer,
  });

  @override
  _UpdateOrderCustomerPageState createState() => _UpdateOrderCustomerPageState();
}

class _UpdateOrderCustomerPageState extends State<UpdateOrderCustomerPage> {
