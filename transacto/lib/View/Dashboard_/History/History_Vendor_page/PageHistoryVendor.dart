...
// import 'package:transacto/View/Dashboard_/History/History_Vendor_page/AmountPendingVendor.dart';
// import 'package:transacto/View/Dashboard_/History/History_Vendor_page/AmountReceivedVendor.dart';
// import 'package:transacto/View/Dashboard_/History/History_Vendor_page/NumberOfOrderVendor.dart';
//
// // Import the custom widget sections
//
// class PageHistoryVendor extends StatefulWidget {
//   const PageHistoryVendor({super.key});
//
//   @override
//   State<PageHistoryVendor> createState() => _PageHistoryVendorState();
// }
//
// class _PageHistoryVendorState extends State<PageHistoryVendor> {
...
//                 NumberOfOrderVendor(customerName: selectedCustomer!)
//               else if (selectedSection == 'Amount Reserved')
//                 AmountReceivedVendor(customerName: selectedCustomer!)
//               else if (selectedSection == 'Amount Pending')
//                   AmountPendingVendor(customerName: selectedCustomer!),
//           ],
//         ),
//       ),
//     );
...
import 'AmountPendingVendor.dart';
import 'AmountReceivedVendor.dart';
import 'NumberOfOrderVendor.dart';
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 10,),
                      buildButton('Amount Reserved', context, screenWidth),
                      SizedBox(width: 10,),
                ...
                if (selectedCustomer != null)
                  if (selectedSection == 'No of Order')
                    ...
                    AmountReservedSectionVendor(customerName: selectedCustomer!)
                  else if (selectedSection == 'Outstanding Amount')
                      AmountPendingSectionVendor(customerName: selectedCustomer!),
              ],
            ),
          );
        },
