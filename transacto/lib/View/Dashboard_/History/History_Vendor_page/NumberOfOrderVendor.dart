...
class NumberOfOrderVendor extends StatefulWidget {
  final String customerName;

  const NumberOfOrderVendor({Key? key, required this.customerName})
      : super(key: key);
  @override
  _NumberOfOrderVendorState createState() => _NumberOfOrderVendorState();
}

class _NumberOfOrderVendorState extends State<NumberOfOrderVendor> {
