...
class AmountReservedSectionVendor extends StatefulWidget {
  final String customerName;

  const AmountReservedSectionVendor({Key? key, required this.customerName})
      : super(key: key);
  @override
  _AmountReservedSectionVendorState createState() => _AmountReservedSectionVendorState();
}

class _AmountReservedSectionVendorState extends State<AmountReservedSectionVendor> {
