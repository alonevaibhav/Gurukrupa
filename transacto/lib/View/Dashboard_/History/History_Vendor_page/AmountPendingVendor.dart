...
class AmountPendingSectionVendor extends StatefulWidget {
  final String customerName;

  const AmountPendingSectionVendor({Key? key, required this.customerName})
      : super(key: key);
  @override
  _AmountPendingSectionVendorState createState() => _AmountPendingSectionVendorState();
}

class _AmountPendingSectionVendorState extends State<AmountPendingSectionVendor> {
  int currentPage = 1; // Start with the first page
  final int itemsPerPage = 6; // Number of items per page
  List<Map<String, dynamic>> customerList = [
    {'name': '9658', 'phone': '1780', 'pending': '522', 'date': '2024-10-01'},
  ...
  Widget _buildDesktopCustomerTable(List<Map<String, dynamic>> customers) {
    return SingleChildScrollView(
      ...
      child: Card(
        ...
        child: Container(
          width: 900,
          height: 200, // Increase height to accommodate content
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10), // Adjust height between header and rows

              // Data Rows with a scrollable container
              Expanded(
                    ...
                    if (index < customers.length) {
                      ...
                      return Row(
                        ...
                        children: List.generate(
                          6,
                              (index) => Expanded(child: SizedBox.expand()),
                        ),
                      );
                    }
                  },
