...
import '../Customer_Order/AddCustomerPaymentsPage.dart';
import 'AddVendorPayment.dart';

class PaymentVendorPage extends StatefulWidget {
  @override
  _PaymentVendorPageState createState() => _PaymentVendorPageState();
}

class _PaymentVendorPageState extends State<PaymentVendorPage> {
    ...
    return SingleChildScrollView(
      ...
      child: DataTable(
        ...
        columns: [
          ...
          DataColumn(label: _buildConstrainedHeader('Vendor Name', minWidth: 150, maxWidth: 300)),
